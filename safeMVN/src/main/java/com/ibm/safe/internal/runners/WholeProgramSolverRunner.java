...
public class WholeProgramSolverRunner extends AbstractSolverRunner {
  ...
  public void run(IResultObserver observer) throws SafeException, IllegalArgumentException, CancelException{
    // TODO Auto-generated method stub

  }

  protected CallGraphEngine createCallGraphEngine() throws PropertiesException, SetUpException {
    ...
    CallGraphEngine cgEngine = new CallGraphEngine(getManager().getCallGraphKind(), getManager(),
        getPerformanceTracker(), modulesCodeKind != CodeKind.J2SE);
