...
public class StagedSolver extends AbstractTypestateSolver {
   ...
   */
  final static TypeStateSolverKind[] stageKinds = {TypeStateSolverKind.UNIQUE,
  ...
  public StagedSolver(AnalysisOptions domoOptions, CallGraph cg, PointerAnalysis pointerAnalysis, TypeStateProperty property,
    ...
    this.outputFile = System.getProperty("outputCsvFile");
   ...
   */
  public ISolverResult perform() throws WalaException, SolverTimeoutException, SetUpException,
    ...
    for (int i = 0; i < stageKinds.length; i++) {
      ...
      try {
        ...
        System.setProperty("outputCsvFile", this.outputFile.replace(".csv", "-"+stageKinds[i] +".csv" ));
