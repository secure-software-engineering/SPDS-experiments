...
public class TypeStateSolverRunner extends WholeProgramSolverRunner {
  ...
  public void run(final IResultObserver observer) throws SafeException, IllegalArgumentException, CancelException{
    TraceReporter tReporter = (shouldMineDFA()) ? makeTraceReporter() : null;
    CallGraphEngine cge = createCallGraphEngine();
    ...
    runSolvers(solvers, observer, AnalysisKind.TYPESTATE, Stages.TYPESTATE, new NullProgressMonitor());
