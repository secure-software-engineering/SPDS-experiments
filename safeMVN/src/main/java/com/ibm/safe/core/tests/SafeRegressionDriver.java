...
//			writer.write(r.nFindings + ";" + test.getExpectedNumberOfFindings() + ";\n");
//			writer.close();
		} else if (shouldCompare && r.nFindings != test.getExpectedNumberOfFindings()) {
	...
	private static void initVMOptions() {
		...
		if (loggingConfigFile == null) {
			System.setProperty(LOGGING_CONFIG_FILE,
					AbstractSafeJavaApplication.class.getClassLoader().getResource(SAFE_LOG_FILE).getFile());
		}
	}
