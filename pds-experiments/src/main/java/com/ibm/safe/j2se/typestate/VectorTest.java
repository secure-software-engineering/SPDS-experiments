...
public final class VectorTest extends AbstractTestCase {

  public void testVectorExample1() throws SafeException, Exception {
  ...
  public void testVectorExample2() throws SafeException, Exception {
    TypestateRegressionUnit test = new TypestateRegressionUnit("j2se.typestate.vector.VectorExample2", 1);
    test.selectTypestateRule("EmptyVector");
    run(test);
  }

  public void testVectorExample3() throws SafeException, Exception {
...
//  The ThrowAnalysis of Soot and WALA are different and introduce problems here. We deactivated the ThrowAnalysis.
  ...
  public void testVectorExample22() throws SafeException, Exception {
    TypestateRegressionUnit test = new TypestateRegressionUnit("j2se.typestate.vector.VectorExample22", 0);
    test.selectTypestateRule("EmptyVector");
    run(test);
  }

  public void testVectorExample23() throws SafeException, Exception {
    TypestateRegressionUnit test = new TypestateRegressionUnit("j2se.typestate.vector.VectorExample23", 0);
    test.selectTypestateRule("EmptyVector");
    run(test);
  }

  public void testVectorExample24() throws SafeException, Exception {
    TypestateRegressionUnit test = new TypestateRegressionUnit("j2se.typestate.vector.VectorExample24", 1);
    test.selectTypestateRule("EmptyVector");
    run(test);
  }

  public void testVectorExample25() throws SafeException, Exception {
    TypestateRegressionUnit test = new TypestateRegressionUnit("j2se.typestate.vector.VectorExample25", 2);
    test.selectTypestateRule("EmptyVector");
    run(test);
  }

  public void testVectorExample26() throws SafeException, Exception {
  ...
  public void testVectorExample27() throws SafeException, Exception {
    TypestateRegressionUnit test = new TypestateRegressionUnit("j2se.typestate.vector.VectorExample27", 0);
    test.selectTypestateRule("EmptyVector");
    run(test);
  }

  public void testVectorExample28() throws SafeException, Exception {
  ...
  public void testVectorExample29() throws SafeException, Exception {
    TypestateRegressionUnit test = new TypestateRegressionUnit("j2se.typestate.vector.VectorExample29", 0);
    test.selectTypestateRule("EmptyVector");
    run(test);
  }

  public void testVectorExample30() throws SafeException, Exception {
